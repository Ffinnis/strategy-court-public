...
.court-result-chart{position:relative;isolation:isolate;margin:0;overflow:hidden;border:1px solid #2b2b2b;border-radius:22px;background:#111;box-shadow:inset 0 1px 0 rgba(255,255,255,.07),inset 0 -1px 0 rgba(255,255,255,.025),0 2px 5px rgba(0,0,0,.72),0 30px 78px rgba(0,0,0,.62),0 74px 140px rgba(0,0,0,.42)}
.chart-header{display:flex;min-height:82px;align-items:center;justify-content:space-between;gap:24px;padding:18px 24px;border-bottom:1px solid #252525;background:#131313}.chart-title{display:flex;min-width:0;align-items:center;gap:22px}.chart-title h3{margin:0;color:#f5f5f5;font-size:16px;font-weight:600;letter-spacing:-.02em}.chart-legend{display:flex;align-items:center;gap:15px;color:#7d7d7d;font-size:10px}.chart-legend span{display:inline-flex;align-items:center;gap:7px;white-space:nowrap}.legend-line{display:block;width:21px;height:0;border-top:2px solid #f5f5f5}.legend-line--dashed{border-top:1px dashed #888}.net-result{display:flex;align-items:baseline;gap:9px;white-space:nowrap}.net-result span{color:#858585;font:500 11px Inter,ui-sans-serif,system-ui,sans-serif}.net-result strong{color:#fff;font:600 22px ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:-.05em}.chart-viewport{overflow-x:auto;overscroll-behavior-inline:contain;scrollbar-color:#3a3a3a transparent;scrollbar-width:thin}.chart-viewport svg{display:block;width:100%;min-width:680px;height:auto;background:#0e0e0e;cursor:crosshair;outline:none}.chart-viewport svg:focus-visible{box-shadow:inset 0 0 0 2px #d8d8d8}.grid-line,.year-grid,.equity-path,.benchmark-path,.drawdown-path,.change-tick,.crosshair{vector-effect:non-scaling-stroke}.grid-line{stroke:#282828;stroke-width:1}.year-grid{stroke:#1f1f1f;stroke-width:1}.axis-label,.year-label{fill:#686868;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.axis-label{font-size:10px}.year-label{font-size:11px}.pane-label{fill:#969696;font:550 11px Inter,ui-sans-serif,system-ui,sans-serif}.equity-path{fill:none;stroke:#f7f7f7;stroke-width:2.25;stroke-linecap:round;stroke-linejoin:round}.benchmark-path{fill:none;stroke:#858585;stroke-width:1.4;stroke-dasharray:6 6;stroke-linecap:round;stroke-linejoin:round}.change-tick{stroke:#5c5c5c;stroke-width:1}.drawdown-area{fill:#1c1c1c}.drawdown-path{fill:none;stroke:#bdbdbd;stroke-width:1.65;stroke-linecap:round;stroke-linejoin:round}.end-label rect{fill:#f4f4f4}.end-label text{fill:#090909;font:650 11px ui-monospace,SFMono-Regular,Menlo,monospace}.drawdown-end-label rect{fill:#252525;stroke:#4b4b4b;stroke-width:1;vector-effect:non-scaling-stroke}.drawdown-end-label text{fill:#d8d8d8;font:550 10px ui-monospace,SFMono-Regular,Menlo,monospace}.hover-layer{pointer-events:none}.crosshair{stroke:#727272;stroke-width:1;stroke-dasharray:3 4}.hover-dot{fill:#f6f6f6;stroke:#0d0d0d;stroke-width:2;vector-effect:non-scaling-stroke}.svg-tooltip rect{fill:#090909;stroke:#444;stroke-width:1;vector-effect:non-scaling-stroke;filter:drop-shadow(0 10px 12px rgba(0,0,0,.55))}.svg-tooltip text{font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.tooltip-date{fill:#a3a3a3;font-size:10px}.tooltip-key{fill:#707070;font:500 9px Inter,ui-sans-serif,system-ui,sans-serif}.tooltip-value{fill:#f0f0f0;font-size:10px;font-weight:600}.tooltip-value--muted{fill:#aaa}.sr-only{position:absolute;width:1px;height:1px;margin:-1px;overflow:hidden;padding:0;border:0;clip:rect(0,0,0,0);white-space:nowrap}
