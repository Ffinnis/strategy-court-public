...
.audit-stack { width: 100%; min-width: 0; max-width: 100%; grid-template-columns: minmax(0, 1fr); margin-inline: auto; }
.audit-stack > *, .audit-lead, .timeline-section, .activity-utilities { min-width: 0; max-width: 100%; }
.audit-filters { min-width: 0; max-width: 100%; }
.audit-filters > .form-select { max-width: 100%; }
.audit-table-wrap { width: 100%; min-width: 0; max-width: 100%; overflow-x: auto; }
.audit-table-wrap:focus-visible { outline: 2px solid #d4d4d8; outline-offset: 3px; }
</style>
