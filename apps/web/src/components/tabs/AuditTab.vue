...
<template>
  <div class="audit-stack">
    <section class="audit-lead">
      <div class="audit-intro">
        <p class="eyebrow">Immutable investigation record</p>
        <h2>Every decision has an actor.</h2>
        <p>User approvals, agent hypotheses, system tests, failed variants, and replay steps remain attributable.</p>
      </div>
...
.audit-stack{display:grid;gap:0;max-width:1100px;color:#e8e8e5}
...
.audit-intro{max-width:700px}.audit-lead .eyebrow{display:inline-flex;width:max-content;margin:0 0 13px;padding:5px 8px;border:1px solid rgba(255,255,255,.1);border-radius:6px;color:#969696;background:rgba(255,255,255,.025);font-size:10px;font-weight:600}.audit-lead h2{margin:0;font-size:30px;letter-spacing:-.04em}.audit-lead p:not(.eyebrow){margin:9px 0 0;color:#858b88;font-size:13px;line-height:1.6}
...
.timeline-section{width:min(100%,820px)}.timeline-heading{padding-bottom:13px;border-bottom:1px solid rgba(255,255,255,.08)}.timeline-heading h3{margin:0 0 5px;font-size:16px}.timeline-heading p{margin:0;color:#70706c;font-size:11px}.timeline{margin:0;padding:0;list-style:none}.timeline li{position:relative;display:grid;grid-template-columns:38px 1fr;gap:15px;padding:19px 0}.timeline li:not(:last-child)::after{position:absolute;top:55px;bottom:-1px;left:18px;width:1px;content:"";background:rgba(255,255,255,.08)}.timeline-icon{position:relative;z-index:1;display:grid;width:36px;height:36px;place-items:center;border-radius:11px;color:#aeb3b0;background:rgba(255,255,255,.055)}.timeline-item--user .timeline-icon,.timeline-item--agent .timeline-icon{color:#e0e0dd}.timeline-meta{display:flex;align-items:center;gap:8px;margin-bottom:8px}.actor-pill{padding:4px 7px;border-radius:999px;color:#9a9a9a;background:rgba(255,255,255,.055);font-size:9px;font-weight:600}.timeline-meta time{color:#666c69;font:9px "IBM Plex Mono",monospace}.timeline h3{margin:0 0 5px;font-size:14px}.timeline p{margin:0;color:#858b88;font-size:12px;line-height:1.6}.event-proof{margin-top:8px}.event-proof summary{width:max-content;color:#5f5f5b;font-size:9px;list-style:none;cursor:pointer}.event-proof summary::-webkit-details-marker{display:none}.event-proof summary::after{margin-left:5px;content:"+"}.event-proof[open] summary::after{content:"−"}.event-proof summary:focus-visible{outline:1px solid #777;outline-offset:3px}.event-id{display:block;margin-top:6px;color:#555b58;font-size:9px}
