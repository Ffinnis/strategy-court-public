  ...
  <div class="probation-page">
    <section v-if="store.monitoringCandidate" class="monitoring-surface">
      ...
      <template v-if="store.monitoringStatus?.status === 'evaluated'">
        ...
        <div class="monitoring-disclosures">
          <details>
            <summary>
              <span><strong>Simulated positions</strong><small>Marked at the evaluated close.</small></span>
              <span class="disclosure-meta"><span class="count-badge">{{ store.monitoringStatus.positions.length }} open</span><ChevronRight :size="14" /></span>
            </summary>
          ...
          <details>
            <summary>
              <span><strong>Changes since the last check</strong><small>Only newly activated states appear here.</small></span>
              <span class="disclosure-meta"><span class="count-badge">{{ store.monitoringStatus.changes.length }}</span><ChevronRight :size="14" /></span>
            </summary>
          ...
          <details v-if="store.monitoringStatus.warnings.length" class="warning-disclosure">
            <summary>
              <span><strong>Warnings</strong><small>Data or evaluation limits that need attention.</small></span>
              <span class="disclosure-meta"><span class="count-badge">{{ store.monitoringStatus.warnings.length }}</span><ChevronRight :size="14" /></span>
            </summary>
      ...
      <div v-else class="monitoring-placeholder">
        <Clock3 :size="18" />
        <span>Check the latest completed bar to establish the first monitoring state.</span>
      </div>
...
.probation-page{width:100%;gap:0;max-width:none}.monitoring-surface{padding:0 0 38px;overflow:visible;border:0;border-bottom:1px solid rgba(255,255,255,.09);border-radius:0;background:none;box-shadow:none}.monitoring-heading{align-items:center}.monitoring-heading h2{margin-top:10px}.monitoring-action{min-width:210px;box-shadow:none}.monitoring-placeholder{justify-content:flex-start;min-height:0;margin-top:26px;padding:20px 0;border:0;border-top:1px solid rgba(255,255,255,.075);border-bottom:1px solid rgba(255,255,255,.075);border-radius:0}.last-check{margin-top:13px}.signal-board{margin-top:26px}.signal-row{border-radius:12px;box-shadow:none}.monitoring-metrics{border-radius:11px}.monitoring-disclosures{display:grid;margin-top:26px;border-top:1px solid rgba(255,255,255,.08)}.monitoring-disclosures details{border-bottom:1px solid rgba(255,255,255,.08)}.monitoring-disclosures summary{display:flex;min-height:58px;align-items:center;justify-content:space-between;gap:18px;color:#d2d2ce;list-style:none;cursor:pointer}.monitoring-disclosures summary::-webkit-details-marker{display:none}.monitoring-disclosures summary>span:first-child{display:grid;gap:4px}.monitoring-disclosures summary strong{font-size:12px}.monitoring-disclosures summary small{color:#72726e;font-size:10px}.disclosure-meta{display:flex!important;grid-auto-flow:column;align-items:center;gap:8px!important;color:#747470}.disclosure-meta svg{transition:transform .16s ease}.monitoring-disclosures details[open] summary{border-bottom:1px solid rgba(255,255,255,.055)}.monitoring-disclosures details[open] .disclosure-meta svg{transform:rotate(90deg)}.monitoring-disclosures summary:focus-visible{outline:1px solid #777;outline-offset:4px}.monitoring-disclosures .monitoring-list,.monitoring-disclosures .quiet-state,.monitoring-disclosures .warning-stack{padding-inline:2px}.monitoring-disclosures .quiet-state{padding-block:20px}.monitoring-disclosures .warning-stack{margin:0;padding-block:12px}.monitoring-locked,.replay-locked{margin:0;padding:22px 0;border:0;border-top:1px solid rgba(255,255,255,.08);border-bottom:1px solid rgba(255,255,255,.08);border-radius:0;background:none;box-shadow:none}.replay-divider{margin-top:38px;padding:0 0 15px;border-bottom:1px solid rgba(255,255,255,.09)}.replay-divider i{display:none}.replay-empty{display:block}.replay-brief{width:100%;align-items:flex-start;padding:30px 0 0;border:0;border-radius:0;text-align:left;background:none;box-shadow:none}.replay-brief__icon{width:42px;height:42px;margin-bottom:14px;border-radius:11px}.replay-range{margin:21px 0;padding:0;background:none}.replay-stack{padding-top:30px}.replay-comparison,.replay-controls,.replay-detail-grid,.replay-trades{border-radius:0}.monitoring-detail-grid>section{padding:0;border:0;background:none}.warning-stack>div{border-radius:8px}
@media(max-width:900px){.monitoring-heading{align-items:flex-start}.replay-stack{padding-top:25px}}
@media(max-width:560px){.monitoring-surface{padding:0 0 30px;border-radius:0}.monitoring-heading h2,.replay-header h2,.replay-brief h2{font-size:27px}.replay-brief{padding:26px 0 0}.monitoring-disclosures summary{min-height:64px}.monitoring-disclosures summary small{max-width:220px}.replay-range{align-items:flex-start}.replay-range svg{transform:rotate(90deg)}}
@media(prefers-reduced-motion:reduce){.spinning{animation:none}.disclosure-meta svg{transition:none}}
</style>
